...
/// A Copycat of [ClampingScrollSimulation] in order to prevent keep scrolling
/// bottom to top.
class SamsungUiScrollSimulation extends Simulation {
  SamsungUiScrollSimulation({
  ...
  double x(double time) {
    ...
    return position! +
        _distance! * _flingDistancePenetration(t) * velocity!.sign;
  }
  ...
  bool isDone(double time) {
    // If scroll direction was upward, and didn't reach the top of the scroll
